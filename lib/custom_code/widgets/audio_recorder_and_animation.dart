...
class _AudioRecorderAndAnimationState extends State<AudioRecorderAndAnimation>
  ...
  void _startTimer() {
    if (_timer == null) {
      // Start a new timer only if it doesn't exist
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        width: _isRecording || _firstTime ? 140 : 160,
                        height: 32,
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                _isRecording || _firstTime ? 'REC' : 'Paused',
                              ...
                              StreamBuilder<int>(
                                stream:
                                    _streamController?.stream ?? Stream.empty(),
